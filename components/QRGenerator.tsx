    ...
    <div className="flex flex-col h-full bg-grey-light p-6 gap-4">
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 text-sm bg-white border border-t-grey-dark border-l-grey-dark border-b-white border-r-white focus:outline-none"
        />
      </div>

      {text && (
        <>
          <div className="flex-1 flex items-center justify-center bg-grey-light border border-t-grey-dark border-l-grey-dark border-b-white border-r-white p-4">
