...
export default function AboutDialog({ onClose }: { onClose: () => void }) {
  return (
    <>
      ...
      {/* Dialog */}
      <div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-200 bg-grey-mid border border-t-white border-l-white border-r-black border-b-black shadow-2xl z-50"
      >
